...
**Pasta:** `api/src/modulos/metas` · `web/pages/metas`.
...
O subtítulo do mockup enuncia a regra e deve permanecer: *"Guardar sai do não alocado do mês."*

---

## §4 — O que não se copia do protótipo

Os botões *Guardar 100* e *Guardar 500* incrementam o acumulado direto no estado, sem mover
