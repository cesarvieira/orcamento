...
| Conta de origem                  | a conta `DEBITO` de onde o dinheiro sai ao guardar. **Vem sempre do corpo da requisição, nunca inferida** — mesma armadilha (e mesmo remédio) que D3 da [EF-05](../../../../docs/especificacoes/EF-05-faturas.md) já fechou para o pagamento de fatura. **Decisão humana · 2026-08-29 (D2)**                                                                                          |
...
| RN-35 | Conta `RESERVA` fica **fora do orçamento e fora do lastro**                                                                                                                                         | leitura de saldo / derivação do lastro | [EF-07 §2 RN-35](../../../../docs/especificacoes/EF-07-metas.md), que cita [EF-06](../../../../docs/especificacoes/EF-06-lastro.md) como fonte — é **RN-27 por outro nome**, dona em `../contas-e-lastro/SKILL.md`; a própria EF-06 já registra a equivalência ([EF-06 §5, nota "a"](../../../../docs/especificacoes/EF-06-lastro.md)) |
...
precedente **D3 da [EF-05](../../../../docs/especificacoes/EF-05-faturas.md)** — a "armadilha do
protótipo" de nunca inferir "a primeira conta de débito" ou qualquer conta por convenção. Quem
guarda dinheiro escolhe explicitamente de onde ele sai.
...
parcela em `../lancamentos-e-parcelamento/SKILL.md` (fork 1: "construída no vocabulário visual das
outras folhas do app", sem fonte no desenho).
...
- [docs/especificacoes/EF-05-faturas.md](../../../../docs/especificacoes/EF-05-faturas.md) — fonte
  do precedente D3 daquela EF, que D2 desta skill repete literalmente ("nunca inferir a conta").
